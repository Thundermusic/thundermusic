...
export async function addHandlers({ onPositionChange, onPlay, onPause, onNext, onPrevious }) {
	if (onPositionChange) {
	...
	if ("mediaSession" in navigator) {
		...
		onPrevious && navigator.mediaSession.setActionHandler("previoustrack", onPrevious)
